	...
	var SearchGithub = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        { onSubmit: this.handleSubmit, className: 'navbar-form navbar-left', role: 'search' },
	        React.createElement(
	          'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Profile = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    this.ref = new Firebase('https://boiling-fire-855.firebaseio.com');
	    this.init();
	  },
	  componentWillUnmount: function componentWillUnmount() {
	    this.unbind('notes');
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "ul",
	        { className: "list-group" },
	        this.props.bio.avatar_url && React.createElement("img", { src: this.props.bio.avatar_url, className: "img-rounded center-block img-responsive" }),
	...
	var AddNote = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement("input", { className: "form-control", ref: "note", placeholder: "Add New Note" }),
	      React.createElement(
	        "span",
